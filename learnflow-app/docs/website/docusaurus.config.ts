...
const config: Config = {
  title: 'LearnFlow',
  tagline: 'Interactive Python Learning Platform',
  ...
  projectName: 'learnflow', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/learnflow/learnflow/tree/main/docs/website/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          to: '/docs/category/skills-and-agents',
          label: 'Skills & Agents',
          position: 'left',
        },
        {
